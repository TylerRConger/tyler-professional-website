    ...
    return (
        <Section className="bg-neutral-800 h-max" sectionId={SectionId.Skills}>
            ...
            <div className="text-white px-10">
                <p>&emsp;&emsp;The project you  requested is unavailable, for a variety of potential reasons, including it was expensive to host or contains information I cannot release publicly. Nonetheless, email me at <a className="underline underline-offset-4 text-red-400" href='mailto:Tyler-Conger@Tyler-Conger.com'>Tyler-Conger@Tyler-Conger.com</a> and I would be happy to release these projects to you. In the meantime here's a Party Parrot</p>
            </div>
            {/* TODO: Just use the img tag right now, consider updating to not reference outside website as this will break at some point*/}
